            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.handleError(this.prisma.user.findUnique({ where: userWhereUniqueInput }), errMsg)];
                    case 1:
                        prismaUser = _a.sent();
                        if (prismaUser) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.handleError(this.prisma.user.create({ data: data }), errMsg)];
                    case 1:
                        prismaUser = _a.sent();
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.handleError(this.prisma.user.update({ data: data, where: where }), errMsg)];
                        case 1:
                            prismaUser = _b.sent();
                            return [2 /*return*/, this.userMap.toDTO(prismaUser)];
                    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.handleError(this.prisma.user["delete"]({ where: where }), errMsg)];
                    case 1:
                        prismaUser = _a.sent();
                        return [2 /*return*/, this.userMap.toDTO(prismaUser)];
                }
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            errMsg = 'Prisma User Repository removeUser error';
                            return [4 /*yield*/, this.handleError(this.prisma.user.findMany({ skip: skip, take: take, cursor: cursor, where: where, orderBy: orderBy }), errMsg)];
                        case 1:
                            prismaUsers = _b.sent();
