...
type DeletePhoto = { (photo: UserPhoto): Promise<void> };
type TakePhoto = { (): Promise<string> };
type SavePicture = { (photo: Photo, fileName: string): Promise<UserPhoto> };
type UseCamera = {
	(): {
...
const useCamera: UseCamera = () => {
	...
	const savePicture: SavePicture = async (photo, fileName) => {
	...
	const deletePhoto: DeletePhoto = async (photo) => {
